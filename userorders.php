...
if (isset($_SESSION['id'])) {
    ...
    $sqlproducts = "SELECT * FROM productorder WHERE userid='$uid' ";
                        ...
                        <tbody>
                            ...
                            <?php while ($rowproducts = mysqli_fetch_array($recordproducts)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="">
                                            <img src="<?php echo $rowproducts['location']; ?>"
                                    ...
                                    <td>
                                        <div style="">
                                            ...
                                            if ($rowproducts['status'] == "") {
                                                ...
                                                echo "<a href='orderstatus.php?productid=$productid'>" . "<div class='btn btn-primary btn-sm btn-block'>Delivered</div>" . "</a>";
                                            } else if ($rowproducts['status'] == "delivered") {
                                                echo "<div class='btn btn-secondary btn-sm btn-block disabled'>SoldOut</div>" . "</a>";
                                            } else if ($rowproducts['status'] == "canceled") {
...
<?php } else {
    header('Location:account.php?alert=login_first');
} ?>