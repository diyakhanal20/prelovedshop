...
if (!isset($_FILES['image']['tmp_name'])) {
    ...
    $image_name= addslashes($_FILES['image']['name']);
           ...
           if (mysqli_query($conn,"INSERT INTO products (name,location,category,discount,price,description,userid,storename) VALUES ('$name','$location','$category','$discount','$price','$description','$userid','$storename')")) {
