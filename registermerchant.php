...
<div class="containers">
        <div class="left__section">
            ...
            <div class="login-regestration__section">
                ...
                <a class="Login-reg" href="loginmerchant.php">Login</a>
        ...
        <div class="right__section">
            <div class="right__section__top">
             ...
             <form method="POST" action="usersignup.php" class="User__form " onsubmit="return matchpass()">
                <div class=" row register-form h-100">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="Address" class="form-control" placeholder="Your Address *" value=""  name="address"required/>
                            
                                
        
                        </div>
                        <div class="form-group">
                            <p class="paraName text-left">Store Name</p>
                            <input type="storename" class="form-control" placeholder="storename *" value=""  name="storename"required/>
