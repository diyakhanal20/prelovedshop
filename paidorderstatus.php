...
$productid=$_GET['productid'];
           $sql = "UPDATE checkout SET status='delivered'WHERE id=$productid";
                //execute the query
                if(mysqli_query($conn,$sql))
                    header("refresh:0;url=paymentorders.php?alert=delivered");
                else
                header("refresh:0;url=paymentorders.php?alert=not_delivered");
