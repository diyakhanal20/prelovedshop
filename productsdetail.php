...
<div id="review_modal" class="modal" tabindex="-1" role="dialog">
      ...
      <a href="checkout.php?id=<?php echo $productid;?>&user=<?php echo $productid;?>&buyerid=<?php echo $buyerid;?>&buyeremail=<?php echo $buyeremail;?>&storename=<?php echo $storename;?>" class="btn btn-primary">Checkout</a>
      <?php }
      else {?>
